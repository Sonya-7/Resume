...
plt.annotate(WorkOneTime, (.02,.488), weight='regular', fontsize=9, alpha=.6) #.02
plt.annotate(WorkOneDesc, (.04,.408), weight='regular', fontsize=9)           #.08

plt.annotate(WorkTwoTitle, (.02,.362), weight='bold', fontsize=10)            #.046
plt.annotate(WorkTwoTime, (.02,.342), weight='regular', fontsize=9, alpha=.6) #.02
plt.annotate(WorkTwoDesc, (.04,.292), weight='regular', fontsize=9)           #.05

plt.annotate(WorkThreeTitle, (.02,.246), weight='bold', fontsize=10)           #.046
plt.annotate(WorkThreeTime, (.02,.226), weight='regular', fontsize=9, alpha=.6) #.02
plt.annotate(WorkThreeDesc, (.04,.176), weight='regular', fontsize=9)           #.05

plt.annotate(WorkFourTitle, (.02,.13), weight='bold', fontsize=10)           #.046
plt.annotate(WorkFourTime, (.02,.11), weight='regular', fontsize=9, alpha=.6) #.02
plt.annotate(WorkFourDesc, (.04,.06), weight='regular', fontsize=9)           #.05
